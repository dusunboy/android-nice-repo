var repoList =
    [
        {
            name: 'guojunyi/HamburgerButton_android',
            link: 'https://github.com/guojunyi/HamburgerButton_android',
            description: 'HamburgerButton(Android版)'
        },
        {
            name: 'maxyou/gesturebutton',
            link: 'https://github.com/maxyou/gesturebutton',
            description: '手势按钮'
        },
        {
            name: 'skyfishjy/android-ripple-background',
            link: 'https://github.com/skyfishjy/android-ripple-background',
            description: '仿5.0Ripple效果'
        },
        {
            name: 'guojunyi/PullDownListView',
            link: 'https://github.com/guojunyi/PullDownListView',
            description: '下拉刷新动画'
        },
        {
            name: 'aicaprio/CurtainView',
            link: 'https://github.com/aicaprio/CurtainView',
            description: '下拉窗帘效果的控件'
        },
        {
            name: 'gcgongchao/flashview',
            link: 'https://github.com/gcgongchao/flashview',
